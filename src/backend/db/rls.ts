...
export const rlsSql: string[] = [
  ...
  "CREATE POLICY tenant_isolation ON agent_runs USING (tenant_id = current_setting('app.tenant_id')::text);",

  "ALTER TABLE tool_executions ENABLE ROW LEVEL SECURITY;",
  "CREATE POLICY tenant_isolation ON tool_executions USING (tenant_id = current_setting('app.tenant_id')::text);",
